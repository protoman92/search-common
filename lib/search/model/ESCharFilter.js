...
function CharFilter() {
   ...
   * @param {Object} Additional settings for this CharFilter.
   */
...
CharFilter.Type = {
   ...
   * @param {Object} MAPPING CharFilter type.
   */
  MAPPING: {
    value: 'mapping',
     ...
     * @param {Object} MAPPINGS_PATH setting.
     */
    MAPPINGS_PATH: {
      value: 'mappings_path',
    },

 ...
 * @param {Boolean} Whether this is a multifield or not.
 */
Field.prototype.multifield = false;

/**
 * Enable or disable dynamic mapping for this field if it is of Object type.
 * If set to strict, unknown fields, when indexed, will throw an Exception.
 * @param {object} true, false or 'strict'.
 */
Field.prototype.dynamicMode = Field.DynamicMode.NONE.value;
...
Field.prototype.setDynamicMode = function (mode) {
...
Field.prototype.getDynamicMode = function () {
  ...
  if (type) {
    ...
    if (fields.length) {
      ...
      if (type.isNestedField || type.isObjectField) {
        /**
         * For nested/object field types, we can set its dynamic value to
         * allow/prevent unidentified child field types.
         */
        inner.dynamic = this.getDynamicMode();
